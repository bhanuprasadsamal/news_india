...
const AdminPanel = () => {
  ...
  // Save links
  const handleSave = () => {
    localStorage.setItem('newsLinks', JSON.stringify(links));
    Swal.fire({
      icon: 'success',
      title: 'Links Updated Successfully!',
      text: 'The links have been saved successfully.',
    });
  };
  ...
  return (
    <div className="container mt-4">
      {!isAuthenticated ? (
        // Login Form with Image on Right
        <div className="row align-items-center">
          ...
          <div className="col-md-6 text-center">
            <img
              src="https://plus.unsplash.com/premium_photo-1661302846246-e8faef18255d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8YWRtaW58ZW58MHx8MHx8fDA%3D" // Replace with your image URL
              alt="Admin Login"
